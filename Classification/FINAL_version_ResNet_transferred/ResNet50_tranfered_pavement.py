...
# Source for normalization: https://www.geeksforgeeks.org/how-to-normalize-images-in-pytorch/.
# so this study randomly chooses 0.5 meand and standatdard devivation considering the medium values between 0 and 1
...
seed = 100  #randomly choosen for arbitrary values
...
## we need true labes and predicted labels
true_labels = [] 
predicted_labels = []
...
print(f'precision_score: {precision_score(true_labels, predicted_labels, average="weighted")}')
...
for classname, correct_count in correct_pred.items():
    ...
    true_labels_class = [label for label, pred in zip(true_labels, predicted_labels) if classes[pred] == classname]
    predicted_labels_class = [pred for label, pred in zip(true_labels, predicted_labels) if classes[pred] == classname]
    
    print(f'F1 score: {f1_score(true_labels_class, predicted_labels_class, average="weighted")}')
    print(f'precision_score: {precision_score(true_labels_class, predicted_labels_class, average="weighted")}')
    print(f'recall_score: {recall_score(true_labels_class, predicted_labels_class, average="weighted")}')
